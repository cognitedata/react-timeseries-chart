...
import { wrapInLogProxy } from '../../proxies/client-sdk-log-proxy';
...
export const TimeseriesChart: React.FC<TimeseriesChartProps> = ({
  ...
  const client = wrapInLogProxy(sdkClient, 'TimeseriesChart');
